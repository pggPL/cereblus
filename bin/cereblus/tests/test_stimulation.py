...
from bin.cereblus.stimulation import Stimulation, StimulationLoader, WrongImageLength, NeuronNotReceptive
from bin.cereblus.neurons.receptor import Receptor
...
def test_load_from_file():
    ...
    stimulation = StimulationLoader.load_from_file("./cereblus/tests/test_stimulations/test_stimulation1.json")
...
def test_too_long_phase():
    with pytest.raises(WrongImageLength):
        stimulation = StimulationLoader.load_from_file("./cereblus/tests/test_stimulations/test_stimulation2.json")
